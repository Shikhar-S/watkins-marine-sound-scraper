...
BASE_DIR = "scraped_data/cut_tapes"  # All data will go under this folder
...
def downloadAllAnimals(url):
    ...
    species_options = species_list.find_all("option")[
        1:
    ...
    for species in tqdm(species_options, desc="Species"):
        ...
        for year_option in tqdm(year_options, desc="Years", leave=False):
            ...
            downloadTable(
                f"http://cis.whoi.edu/science/B/whalesounds/{url_fin}", name, year
            )
